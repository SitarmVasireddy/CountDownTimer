package com.example.nani.countdowntimer;
...
//            String getMinutes = minutes.getText().toString();//Get minutes from edittexf
            ...
            if (!C_time.equals("") && C_time.length() > 0) {
                int noOfMinutes = Integer.parseInt(C_time) * 60 * 1000;//Convert minutes into milliseconds
